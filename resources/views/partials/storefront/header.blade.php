            ...
            <div class="row wrapper-header align-items-center">
                ...
                <div class="col-md-4 col-6">
                    <a href="{{ route('home') }}" class="logo-header">
                        <img src="{{ asset('assets/images/logo/logo-dark.svg') }}" alt="Meals on Wheels" class="logo">
                    </a>
                </div>
                ...
                <div class="col-md-4 col-3">
                    <ul class="nav-icon d-flex justify-content-end align-items-center gap-20 box-nav-ul">
                        ...
                        @auth
                            <li class="nav-account menu-item position-relative dropdown">
                                <a href="#" class="nav-icon-item align-items-center gap-5 item-link" id="accountDropdown"
                                    data-bs-toggle="dropdown" aria-expanded="false">
                                    <i class="icon icon-account"></i>
                                    <span class="text">Hey, {{ ucwords(auth()->user()->firstname) }}</span>
                                ...
                                <ul class="dropdown-menu menu-list" aria-labelledby="accountDropdown">
                                    ...
                                    <li class="d-block mx-3">
                                        <a class="menu-link-text link" href="{{ route('logout') }}"
            ...
            <div class="wrapper-header d-flex justify-content-between align-items-center">
                ...
                <div class="box-right">
                    ...
                    <div class="number d-grid">
                        <a href="tel:+919123654780" class="phone"> 9123654780</a>
