...
return [
    ...
    */
    ...
    'options' => [
         ...
         */
        // Embed only the glyphs a document actually uses. Without this every
        // file carries the whole typeface, which took a one page invoice from
        // roughly 8 KB to over 400 KB.
